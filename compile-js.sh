...
if [ "$1" = "dist" ];then
    ...
    JS_IMMUTABLE=src/lib/immutable-js/dist/immutable.min.js
else
...
#    JS_FASTDOM="src/lib/fastdom/fastdom.js src/lib/fastdom/fastdom-strict.js"
    ...
    JS_IMMUTABLE=src/lib/immutable-js/dist/immutable.js
fi
...
LIBS="${JS_FASTDOM} ${JS_FASTCLICK} ${JS_LODASH} ${JS_IMMUTABLE}"
